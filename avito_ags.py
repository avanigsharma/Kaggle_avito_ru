...
dataFolder = "/Users/agsharma/git/kaggle/Kaggle_avito_ru/data"
...
def main():
    ...
    featureIndexes = processData(os.path.join(dataFolder,"avito_train.tsv"), itemsLimit=30000)
    json.dumps(featureIndexes)
    for k in featureIndexes:
       print k.encode('utf-8') , ":", featureIndexes[k];
